...
#' @docType data
#' @format a data frame with 221 rows and 100 variables (genes). Row names are
#' identifiers for individuals.
#'
#' @source The raw data were download from
#' \url{https://gtexportal.org/home/index.html}. The TMM normalization of
#' RNA-seq expression was performed with the R package \code{edgeR}.
#'
...
#' @name thyroid
#' @format a data frame with 221 rows and 50 variables (genes). Rown ames are
#' identifiers for individuals.
#'
#' @source The raw data were downloaded from
#' \url{https://gtexportal.org/home/index.html}. The TMM normalisation of
#' RNA-seq expression was performed with the R package \code{edgeR}.
#' @author Alyssa Imbert <alyssa.imbert@gmail.com>
